...
export let NETWORK = networks.bitcoin
...
export const calculateFTFundsRequired = (numberOfInputs: any, numberOfOutputs: any, satsByte: number, mintDataLength = 0, baseTxByteLength = 300) => {
    // The default base includes assumes 1 input and 1 output with room to spare
    const estimatedTxSizeBytes = baseTxByteLength + mintDataLength;
...
export const calculateUtxoFundsRequired = (numberOfInputs: any, numberOfOutputs: any, satsByte: number, mintDataLength = 0, baseTxByteLength = 300) => {
    // The default base includes assumes 1 input and 1 output with room to spare
    const estimatedTxSizeBytes = baseTxByteLength + mintDataLength;
    const baseInputSize = 36 + 4 + 64
    const baseOutputSize = 8 + 20 + 4;
...
export class AtomicalsPayload {
    ...
    constructor(private originalData: any) {
        ...
        function validateWhitelistedDatatypes(x: any, allowBuffer = true): any {
